    ...
    var t = {
        45704: (t, e, i) => {
          ...
          function d(t, e, i) {
              ...
              m =
                ...
                (function (t) {
                  var e = t.getBoundingClientRect(),
                    i = (0, u.NM)(e.width) / t.offsetWidth || 1,
                    n = (0, u.NM)(e.height) / t.offsetHeight || 1;
                  return 1 !== i || 1 !== n;
                })(e),
              g = (0, c.Z)(e),
              _ = (0, n.Z)(t, m),
            ...
            return (
              (p || (!p && !i)) &&
                (("body" !== (0, a.Z)(e) || (0, h.Z)(g)) &&
                  (v =
                    (d = e) !== (0, o.Z)(d) && (0, r.Re)(d)
                      ? {
                          scrollLeft: (f = d).scrollLeft,
                          scrollTop: f.scrollTop,
                        }
                      : (0, s.Z)(d)),
                (0, r.Re)(e)
                  ? (((b = (0, n.Z)(e, !0)).x += e.clientLeft),
                    (b.y += e.clientTop))
                  : g && (b.x = (0, l.Z)(g))),
              {
              ...
              var s,
                ...
                u = {
                  ...
                  setOptions: function (i) {
                    ...
                    var a = (function (t) {
                      var e = _(t);
                      return g.xs.reduce(function (t, i) {
                        return t.concat(
                          e.filter(function (t) {
                            return t.phase === i;
                          })
        ...
        62556: (t, e, i) => {
          ...
          function o(t) {
            return (
              t instanceof (0, n.Z)(t).HTMLElement || t instanceof HTMLElement
            );
          }
          function r(t) {
            return (
          ...
          const d = {
            ...
            fn: function (t) {
              var e,
                ...
                m = (0, n.Z)(i.placement),
                g = (0, a.Z)(m),
                _ = [u.t$, u.F2].indexOf(m) >= 0 ? "height" : "width";
              if (f && p) {
                var v = (function (t, e) {
                    return (
                      (t =
          ...
          function d(t) {
            ...
            if (g) {
              ...
              if (
                ...
                (O = n.I),
                  (E -=
                    (v && C.visualViewport ? C.visualViewport.height : L[S]) -
                    l.height),
                  (E *= m ? 1 : -1);
              if (c === n.t$ || ((c === n.we || c === n.I) && d === n.ut))
                (x = n.F2),
                  (y -=
                    (v && C.visualViewport ? C.visualViewport.width : L[D]) -
                    l.width),
                  (y *= m ? 1 : -1);
            }
            var I,
              P = Object.assign({ position: p }, g && u),
              Z =
                !0 === _
                  ? (function (t) {
                      var e = t.x,
              ...
              if (!e.modifiersData[n]._skip) {
                for (
                  var r = i.mainAxis,
                    ...
                    A = [E].concat(k).reduce(function (t, i) {
                      return t.concat(
                        (0, o.Z)(i) === h.d7
                          ? (function (t, e) {
                              void 0 === e && (e = {});
                  ...
                  var I = A[D],
                    ...
                    R = N ? (Z ? h.F2 : h.t$) : Z ? h.I : h.we;
                  x[M] > O[M] && (R = s(R));
                  var B = s(R),
                    H = [];
                  if (
                    (u && H.push(j[P] <= 0),
                    f && H.push(j[R] <= 0, j[B] <= 0),
                    H.every(function (t) {
                      return t;
                    }))
                  ) {
              ...
              if (I) {
                if (m) {
                  var B,
                    ...
                    Y = C === n.BL ? -Z[$] : -P[$],
                    X = e.elements.arrow,
                    K = T && X ? (0, a.Z)(X) : { width: 0, height: 0 },
                    ...
                    tt = (0, r.u)(0, P[$], K[$]),
                    et = L
                      ? P[$] / 2 - z - tt - G - M.mainAxis
                      : V - tt - G - M.mainAxis,
                    it = L
                      ? -P[$] / 2 + z + tt + J + M.mainAxis
                      : Y + tt + J + M.mainAxis,
                    nt = e.elements.arrow && (0, l.Z)(e.elements.arrow),
                    st = nt
                      ? "y" === S
                        ? nt.clientTop || 0
                        : nt.clientLeft || 0
                      : 0,
                    ot = null != (B = null == j ? void 0 : j[S]) ? B : 0,
                    rt = W + et - ot - st,
                    at = W + it - ot,
                    lt = (0, r.u)(
                      T ? (0, d.VV)(U, rt) : U,
                ...
                if (_) {
                  var ct,
                    ...
                    pt = dt + x[ht],
                    mt = dt - x[ut],
                    gt = -1 !== [n.we, n.t$].indexOf(O),
                    _t = null != (ct = null == j ? void 0 : j[D]) ? ct : 0,
                    vt = gt ? pt : dt - P[ft] - Z[ft] - _t + M.altAxis,
                    bt = gt ? dt + P[ft] + Z[ft] - _t - M.altAxis : mt,
                    yt =
                      T && gt
                        ? (0, r.q)(vt, dt, bt)
                        : (0, r.u)(T ? vt : pt, dt, T ? bt : mt);
                  (I[D] = yt), (R[D] = yt - dt);
                }
                e.modifiersData[f] = R;
              }
        ...
        20804: (t, e, i) => {
          ...
          var n = i(45704),
            ...
            u = i(66896),
            d = i(19892),
            f = [s.Z, o.Z, r.Z, a.Z, l.Z, c.Z, h.Z, u.Z, d.Z],
        ...
        6486: (t, e, i) => {
          ...
          function T(t, e) {
            ...
            var i = e,
              ...
              v = i.padding,
              T = void 0 === v ? 0 : v,
              k = (0, w.Z)("number" != typeof T ? T : (0, E.Z)(T, n.mv)),
              A = p === n.k5 ? n.YP : n.k5,
              x = t.rects.popper,
              O = t.elements[g ? A : p],
              C = b(
                (0, d.kK)(O)
                  ? O
                  : O.contextElement || (0, o.Z)(t.elements.popper),
                l,
                h
              ),
              L = (0, f.Z)(t.elements.reference),
              S = (0, y.Z)({
                reference: L,
                element: x,
                strategy: "absolute",
              ...
              D = _(Object.assign({}, x, S)),
              I = p === n.k5 ? D : L,
              P = {
                top: C.top - I.top + k.top,
                bottom: I.bottom - C.bottom + k.bottom,
                left: C.left - I.left + k.left,
                right: I.right - C.right + k.right,
              },
          ...
          function s(t, e) {
            if (t && e) {
              ...
              t.addEventListener("click", function () {
                r || (r = (0, n.fi)(t, e, { placement: "bottom" })),
                  a === i && ((e.style.visibility = "visible"), (a = s));
              }),
                window.addEventListener("click", function (t) {
                  a !== s
                    ? t.composedPath().includes(e) ||
                      a !== o ||
                      ((e.style.visibility = "hidden"), (a = i))
                    : (a = o);
                });
            }
          }
        ...
        91205: (t, e, i) => {
          ...
          const b = "transitionend",
            ...
            j = (t, e, i = !0) => {
              ...
              let s = !1;
              const o = ({ target: i }) => {
                i === e && ((s = !0), e.removeEventListener(b, o), M(t));
              };
          ...
          function K(t, e, i) {
            const n = "string" == typeof e,
              s = n ? i : e;
            let o = J(t);
            return z.has(o) || (o = t), [n, s, o];
          }
          function Q(t, e, i, n, s) {
            if ("string" != typeof e || !t) return;
            if ((i || ((i = n), (n = null)), q.test(e))) {
              const t = (t) =>
                function (e) {
                  if (
                    !e.relatedTarget ||
          ...
          const tt = {
              ...
              off(t, e, i, n) {
                ...
                if (void 0 !== o) {
                  if (!l || !l[r]) return;
                  return void G(t, l, r, o, s ? i : null);
                }
                c &&
                  Object.keys(l).forEach((i) => {
                    !(function (t, e, i, n) {
                      ...
                      Object.keys(s).forEach((o) => {
                        if (o.includes(n)) {
                          const n = s[o];
                          G(t, e, i, n.originalHandler, n.delegationSelector);
                        }
                      });
                    })(t, l, i, e.slice(1));
                  });
          ...
          class nt {
            ...
            static getInstance(t) {
              return it.get(A(t), this.DATA_KEY);
            }
            ...
            ut = {
              ...
              focusableChildren(t) {
                const e = [
                  ...
                  .join(", ");
                return this.find(e, t).filter((t) => !C(t) && O(t));
              },
            },
            dt = "carousel",
            ft = {
          ...
          class Tt extends nt {
            ...
            to(t) {
              ...
              if (this._isSliding)
                return void tt.one(this._element, yt, () => this.to(t));
            ...
            _handleSwipe() {
              ...
              (this.touchDeltaX = 0), e && this._slide(e > 0 ? vt : _t);
            }
            _addEventListeners() {
            ...
            _addTouchEventListeners() {
              ...
              ut.find(".carousel-item img", this._element).forEach((t) => {
                ...
                this._pointerEvent
                  ? (tt.on(this._element, "pointerdown.bs.carousel", (t) =>
                      e(t)
                    ),
                    tt.on(this._element, "pointerup.bs.carousel", (t) => n(t)),
                    this._element.classList.add("pointer-event"))
                  : (tt.on(this._element, "touchstart.bs.carousel", (t) =>
                      e(t)
                    ),
            ...
            _getItemIndex(t) {
              return (
                (this._items =
                  t && t.parentNode
                    ? ut.find(".carousel-item", t.parentNode)
                    : []),
            ...
            _getItemByOrder(t, e) {
              const i = t === mt;
              return R(this._items, e, i, this._config.wrap);
            }
            ...
            static carouselInterface(t, e) {
              const i = Tt.getOrCreateInstance(t, e);
              let { _config: n } = i;
            ...
            static dataApiClickHandler(t) {
              ...
              n && (i.interval = !1),
                Tt.carouselInterface(e, i),
                n && Tt.getInstance(e).to(n),
                t.preventDefault();
            }
          }
          tt.on(
            ...
            Tt.dataApiClickHandler
          ),
            tt.on(window, "load.bs.carousel.data-api", () => {
              const t = ut.find('[data-bs-ride="carousel"]');
              for (let e = 0, i = t.length; e < i; e++)
                Tt.carouselInterface(t[e], Tt.getInstance(t[e]));
            }),
            N(Tt);
          const kt = "collapse",
            At = "bs.collapse",
            xt = { toggle: !0, parent: null },
            Ot = { toggle: "boolean", parent: "(null|element)" },
            Ct = "show",
            Lt = "collapse",
            St = "collapsing",
            Dt = "collapsed",
          ...
          class Zt extends nt {
            ...
            show() {
              ...
              if (this._config.parent) {
                const t = ut.find(It, this._config.parent);
                e = ut
                  .find(
              ...
              if (e.length) {
                ...
                if (
                  ((t = n ? Zt.getInstance(n) : null), t && t._isTransitioning)
                )
                  return;
              }
              if (
                tt.trigger(this._element, "show.bs.collapse").defaultPrevented
              )
                return;
              e.forEach((e) => {
                i !== e && Zt.getOrCreateInstance(e, { toggle: !1 }).hide(),
                  t || it.set(e, At, null);
              });
            ...
            hide() {
              if (this._isTransitioning || !this._isShown()) return;
              if (
                tt.trigger(this._element, "hide.bs.collapse").defaultPrevented
              )
                return;
          ...
          const Nt = "dropdown",
            ...
            Ft = "click.bs.dropdown.data-api",
            $t = "keydown.bs.dropdown.data-api",
            Wt = "show",
            Ut = '[data-bs-toggle="dropdown"]',
            qt = ".dropdown-menu",
            zt = Z() ? "top-end" : "top-start",
            Vt = Z() ? "top-start" : "top-end",
            Yt = Z() ? "bottom-end" : "bottom-start",
            Xt = Z() ? "bottom-start" : "bottom-end",
            Kt = Z() ? "left-start" : "right-start",
            Qt = Z() ? "right-start" : "left-start",
            Gt = {
              offset: [0, 2],
          ...
          class te extends nt {
            ...
            _completeHide(t) {
              tt.trigger(this._element, "hide.bs.dropdown", t)
                ...
                ("ontouchstart" in document.documentElement &&
                  []
                    .concat(...document.body.children)
                    .forEach((t) => tt.off(t, "mouseover", S)),
            ...
            _getConfig(t) {
              if (
                ...
                x(Nt, t, this.constructor.DefaultType),
            ...
            _getMenuElement() {
              return ut.next(this._element, qt)[0];
            }
            _getPlacement() {
              const t = this._element.parentNode;
              if (t.classList.contains("dropend")) return Kt;
            ...
            _selectMenuItem({ key: t, target: e }) {
              const i = ut
                ...
                .filter(O);
              i.length && R(i, e, t === Bt, !i.includes(e)).focus();
            }
            static jQueryInterface(t) {
              return this.each(function () {
            ...
            static dataApiKeydownHandler(t) {
              if (
                /input|textarea/i.test(t.target.tagName)
                  ? t.key === jt ||
                    (t.key !== Mt &&
                      ((t.key !== Bt && t.key !== Rt) || t.target.closest(qt)))
                  : !Ht.test(t.key)
              )
                return;
              ...
              const i = this.matches(Ut) ? this : ut.prev(this, Ut)[0],
                n = te.getOrCreateInstance(i);
              if (t.key !== Mt)
                return t.key === Rt || t.key === Bt
                  ? (e || n.show(), void n._selectMenuItem(t))
                  : void ((e && t.key !== jt) || te.clearMenus());
              n.hide();
            }
          }
          tt.on(document, $t, Ut, te.dataApiKeydownHandler),
            tt.on(document, $t, qt, te.dataApiKeydownHandler),
            tt.on(document, Ft, te.clearMenus),
            tt.on(document, "keyup.bs.dropdown.data-api", te.clearMenus),
            tt.on(document, Ft, Ut, function (t) {
          ...
          class ne {
            ...
            _applyManipulationCallback(t, e) {
              k(t) ? e(t) : ut.find(t, this._element).forEach(e);
            }
            isOverflowing() {
          ...
          class ce {
            ...
            _emulateAnimation(t) {
              j(t, this._getElement(), this._config.isAnimated);
            }
          }
          ...
          class pe {
            ...
            _handleFocusin(t) {
              ...
              0 === n.length
                ? i.focus()
                : this._lastTabNavDirection === fe
                ? n[n.length - 1].focus()
                : n[0].focus();
            }
            _handleKeydown(t) {
              "Tab" === t.key &&
                (this._lastTabNavDirection = t.shiftKey ? fe : "forward");
            }
            _getConfig(t) {
              return (
          ...
          const me = "modal",
            ge = ".bs.modal",
            _e = "Escape",
            ve = { backdrop: !0, keyboard: !0, focus: !0 },
            be = {
            ...
            ke = "keydown.dismiss.bs.modal",
            Ae = "mousedown.dismiss.bs.modal",
            xe = "modal-open",
            Oe = "show",
            Ce = "modal-static";
          class Le extends nt {
            ...
            _initializeFocusTrap() {
              return new pe({ trapElement: this._element });
            }
            _getConfig(t) {
              return (
                (t = {
            ...
            _setEscapeEvent() {
              this._isShown
                ? tt.on(this._element, ke, (t) => {
                    this._config.keyboard && t.key === _e
                      ? (t.preventDefault(), this.hide())
                      : this._config.keyboard ||
                        t.key !== _e ||
                        this._triggerBackdropTransition();
                  })
                : tt.off(this._element, ke);
            }
            _setResizeEvent() {
              this._isShown
              ...
              (this._element.style.display = "none"),
                ...
                this._backdrop.hide(() => {
                  document.body.classList.remove(xe),
                    ...
                    tt.trigger(this._element, ye);
                });
            }
            _showBackdrop(t) {
              tt.on(this._element, Te, (t) => {
            ...
            _triggerBackdropTransition() {
              if (
                tt.trigger(this._element, "hidePrevented.bs.modal")
                  .defaultPrevented
              )
                return;
          ...
          class Me extends nt {
            ...
            show(t) {
              ...
              if (
                tt.trigger(this._element, "show.bs.offcanvas", {
                  relatedTarget: t,
                }).defaultPrevented
              )
                return;
            ...
            hide() {
              if (!this._isShown) return;
              if (
                tt.trigger(this._element, "hide.bs.offcanvas").defaultPrevented
              )
                return;
              this._focustrap.deactivate(),
                this._element.blur(),
          ...
          function $e(t, e, i) {
            ...
            for (let t = 0, i = s.length; t < i; t++) {
              ...
              const o = [].concat(...i.attributes),
                r = [].concat(e["*"] || [], e[n] || []);
              o.forEach((t) => {
                He(t, r) || i.removeAttribute(t.nodeName);
              });
            }
          ...
          class si extends nt {
            ...
            toggle(t) {
              if (this._isEnabled)
                if (t) {
                  ...
                  if (this.getTipElement().classList.contains(Ke))
            ...
            _enter(t, e) {
              (e = this._initializeOnDelegatedTarget(t, e)),
                ...
                e.getTipElement().classList.contains(Ke) || e._hoverState === Qe
                  ? (e._hoverState = Qe)
            ...
            _getConfig(t) {
              ...
              return (
                ...
                x(We, t, this.constructor.DefaultType),
                t.sanitize &&
                  (t.template = $e(t.template, t.allowList, t.sanitizeFn)),
                t
              );
            }
            _getDelegateConfig() {
          ...
          class vi extends nt {
                ...
                i.classList.contains(fi)
                  ...
                  : ut.parents(i, ".nav, .list-group").forEach((t) => {
                      ut
                        ...
                        .forEach((t) => t.classList.add(pi)),
                        ut.prev(t, ".nav-item").forEach((t) => {
                          ut.children(t, mi).forEach((t) =>
                            t.classList.add(pi)
                          );
                        });
                    }),
            ...
            _clear() {
              ut.find(gi, this._config.target)
                .filter((t) => t.classList.contains(pi))
                .forEach((t) => t.classList.remove(pi));
            }
            static jQueryInterface(t) {
              return this.each(function () {
          ...
          tt.on(window, "load.bs.scrollspy.data-api", () => {
            ut.find('[data-bs-spy="scroll"]').forEach((t) => new vi(t));
          }),
            N(vi);
          const bi = "active",
            yi = "fade",
          ...
          class ki extends nt {
            ...
            show() {
              ...
              if (i) {
                const e = "UL" === i.nodeName || "OL" === i.nodeName ? Ti : Ei;
            ...
            _transitionComplete(t, e, i) {
              ...
              t.classList.add(bi),
                ...
                D(t),
                t.classList.contains(yi) && t.classList.add(wi);
              let n = t.parentNode;
              if (
          ...
          class Di extends nt {
            ...
            hide() {
              if (!this._element.classList.contains(Oi)) return;
            ...
            _getConfig(t) {
              return (
                ...
                x(Ai, t, this.constructor.DefaultType),
                t
              );
            }
            _maybeScheduleHide() {
      ...
      (() => {
        ...
        var a = (function () {
          ...
          return (
            ...
            (a = [
              {
                key: "fromTransformMatrix",
                value: function (i) {
                  var n = window.getComputedStyle(i).transform;
                  if (0 === n.length || !n.startsWith("matrix")) return new t();
                  var s = e(
                      n
                    ...
                    p = void 0 === f ? 0 : f,
                    m = s[5];
                  return new t(r, l, h, d, p, void 0 === m ? 0 : m);
                },
              },
              {
                key: "fromElement",
                value: function (e) {
                  var i = t.fromTransformMatrix(e);
                  return new t(1, 0, 0, 1, e.offsetTop, e.offsetLeft).multiply(
                    i
                  );
                },
              },
              {
                key: "scaleMatrix",
                value: function (e) {
                  return new t(e, 0, 0, e, 0, 0);
                },
              },
              {
                key: "translateMatrix",
                value: function (e, i) {
                  return new t(1, 0, 0, 1, e, i);
                },
              },
              {
                key: "scaleAround",
                value: function (e, i, n, s) {
                  return t
                    .translateMatrix(n, s)
                    .multiply(t.scaleMatrix(i))
                    .multiply(t.translateMatrix(e.tx, e.ty));
                },
              },
              {
                key: "translate",
                value: function (e, i, n) {
                  return e.multiply(t.translateMatrix(i, n));
                },
              },
              {
                key: "identity",
            ...
            (n = [
              ...
              },
              {
                key: "hasScale",
                value: function () {
                  return 1 !== this.a || 1 !== this.d;
                },
              },
              {
                key: "multiply",
                value: function (e) {
                  var i = e.a * this.a + e.c * this.b,
                    n = e.a * this.c + e.c * this.d,
                    s = e.a * this.tx + e.c * this.ty + e.tx;
                  return new t(
                    i,
                    e.b * this.a + e.d * this.b,
                    n,
                    e.b * this.c + e.d * this.d,
                    s,
                    e.b * this.tx + e.d * this.ty + e.ty
                  );
                },
              },
              {
        ...
        var u = c(function t(e) {
          !(function (t, e) {
            ...
            h(this, "identifier", void 0),
            h(this, "screenX", void 0),
            h(this, "screenY", void 0),
            h(this, "clientX", void 0),
            h(this, "clientY", void 0),
            h(this, "pageX", void 0),
            h(this, "pageY", void 0),
        ...
        var p = (function () {
          function t() {
            !(function (t, e) {
              ...
              f(this, "_identifier", void 0),
              f(this, "_lastUpdate", void 0),
              f(this, "_count", void 0),
              this.dropAll();
          }
          var e, i, n;
          return (
            ...
            (i = [
              {
                ...
                value: function (t) {
                  ...
                  t === this._identifier &&
                  this._lastUpdate &&
                  e - this._lastUpdate < 500 &&
                  this._count < 2
                    ? ((this._lastUpdate = new Date()), this._count++)
                    : ((this._identifier = t),
        ...
        Math.hypot =
          ...
          function () {
            for (var t = 0, e = arguments.length, i = 0; i < e; i++) {
              if (arguments[i] === 1 / 0 || arguments[i] === -1 / 0)
                return 1 / 0;
            ...
            (i = [
              {
                key: "cosOfAngle",
                value: function (t) {
                  return (this.x * t.x + this.y * t.y) / (this.len * t.len);
                },
              },
            ]) && m(e.prototype, i),
            n && m(e, n),
          ...
          A = (function () {
            function t() {
              !(function (t, e) {
                ...
                T(this, "_touches", void 0),
                T(this, "_clicking", void 0),
                (this._touches = []),
                (this._clicking = new p());
            }
            var e, i, n;
            return (
              (e = t),
              (i = [
                {
                  key: "_find",
                  value: function (t) {
                    return this._touches.find(function (e) {
                      return e.touch.identifier === t;
                    });
                  },
                },
                {
                  key: "update",
                  value: function (t) {
                    var e = this._find(t.identifier);
                    e
                      ? ((e.prevTouch = new u(e.touch)),
                        (e.touch = new u(t)),
                        this._clicking.dropAll())
                      : (this._touches.push({
                          touch: new u(t),
                          prevTouch: new u(t),
                          startTouch: new u(t),
                        }),
                        this._clicking.updateClick(t.identifier));
                  },
                },
                {
                  key: "updateIn",
                ...
                },
                {
                  key: "remove",
                  value: function (t) {
                    this._touches = this._touches.filter(function (e) {
                      return e.touch.identifier !== t.identifier;
                    });
                  },
                },
                {
                ...
                },
                {
                  key: "getScale",
                  value: function () {
                    if (this._touches.length < 2) return null;
                    var t = this._touches[0],
                      e = this._touches[1],
                      i = t.startTouch.clientX,
                      n = t.startTouch.clientY,
                      s = t.touch.clientX,
                      o = t.touch.clientY,
                      r = t.startTouch.clientX,
                      a = t.startTouch.clientY,
                      l = t.touch.clientX,
                      c = t.touch.clientY,
                      h = _.fromPoints(i, n, s, o),
                      u = _.fromPoints(r, a, l, c),
                      d = {
                        x: (e.startTouch.clientX + t.startTouch.clientX) / 2,
                        y: (e.startTouch.clientY + t.startTouch.clientY) / 2,
                      },
                      f = _.fromPoints(i, n, d.x, d.y),
                      p = _.fromPoints(r, a, d.x, d.y),
                      m = _.fromPoints(s, o, d.x, d.y),
                      g = _.fromPoints(l, c, d.x, d.y),
                      v = f.len - m.len,
                      y = p.len - g.len,
                      w =
                        v > 0 && y > 0 && h.cosOfAngle(u) > Math.SQRT2 / 2
                          ? (k(m.len, f.len, 0) + k(g.len, p.len, 0)) / 2
                          : ((h.len + u.len) / 2) * 0.01 + 1;
                    return b(b({}, d), {}, { scale: w });
                  },
                },
                {
                  key: "getOffset",
                  value: function () {
                    if (!this._touches.length) return null;
                    if (1 === this._touches.length) {
                      var t = this._touches[0];
                      return {
                        x: t.touch.clientX - t.prevTouch.clientX,
                        y: t.touch.clientY - t.prevTouch.clientY,
                      };
                    }
                    return null;
                  },
                },
                {
                  key: "hasDoubleClick",
                  value: function () {
                    return this._clicking.isDoubleClick();
                  },
                },
              ]) && E(e.prototype, i),
              n && E(e, n),
        ...
        var C = (function () {
          function e(i) {
            !(function (t, e) {
              ...
              O(this, "_state", void 0),
              O(this, "_element", void 0),
              O(this, "_activeTouches", void 0),
              O(this, "_startTransform", void 0),
              (this._element = i),
              (this._state = t),
              (this._activeTouches = new A()),
            ...
            (n = [
              {
                ...
                value: function () {
                  if (
                    (this._state === t &&
                      (this._startTransform = a.fromTransformMatrix(
                        this._element
                      )),
                    this._activeTouches.length)
                  )
                    if (1 === this._activeTouches.length) {
                      this._state = "translate";
                      var e = a.fromTransformMatrix(this._element),
                        i = this._activeTouches.getOffset(),
                        n = i.x,
                        s = i.y,
                        o = e.multiply(a.translateMatrix(n, s));
                      this._element.style.transform = o.toString();
                    } else {
                      this._state = "scaled";
                      var r = this._activeTouches.getScale();
                      if (!r) return;
                      var l = r.scale,
                        c =
                          (r.x,
                          r.y,
                          this._startTransform.multiply(a.scaleMatrix(l)));
                      this._element.style.transform = c.toString();
                    }
                  else (this._state = t), (this._startTransform = null);
                },
              },
              {
                key: "_onTouchStart",
                value: function (t) {
                  t.preventDefault(),
                    t.stopPropagation(),
                    this._activeTouches.updateIn(t.changedTouches);
                },
              },
              {
                key: "_onTouchMove",
              ...
              },
              {
                ...
                value: function (t) {
                  t.preventDefault(),
                    t.stopPropagation(),
                    this._activeTouches.removeIn(t.changedTouches),
                    this._updateState(),
                    this._activeTouches.hasDoubleClick()
                      ? this._onDoubleClick()
              ...
              },
              {
                ...
                value: function () {
                  this._isElementFullVisible()
                    ? this._toDefaultPosition()
                    : this._fixWhenElementIsOut();
                },
              },
              {
                key: "_fixWhenElementIsOut",
                value: function () {
                  var t = this._element.getBoundingClientRect(),
                    e = this._element.parentElement.getBoundingClientRect(),
                    i = null,
                    n = a.fromTransformMatrix(this._element),
                    s = a.scaleMatrix(n.a);
                  if (t.x - e.x > 0)
                    i = s.multiply(a.translateMatrix(n.tx - t.x - e.x, n.ty));
                  else if (e.x + e.width - (t.x + t.width) > 0) {
                    var o = a.translateMatrix(
                      n.tx + (e.x + e.width) - (t.x + t.width),
                      n.ty
                    );
                    i = s.multiply(o);
                  }
                  t.y - e.y > 0
                    ? (i = s.multiply(
                        a.translateMatrix(n.tx, n.ty - t.y - e.y)
                      ))
                    : e.y + e.height - (t.y + t.height) > 0 &&
                      (i = a.translateMatrix(
                        n.tx,
                        n.ty + (e.y + e.height) - (t.y + t.height)
                      )),
                    i && this._applyWithAnimation(i);
                },
              },
              {
                key: "_isElementFullVisible",
                value: function () {
                  var t = this._element.getBoundingClientRect(),
                    e = this._element.parentElement.getBoundingClientRect();
              ...
              },
              {
                key: "_onDoubleClick",
                value: function () {
                  if (a.fromTransformMatrix(this._element).noTransform()) {
                    var t = a.scaleMatrix(1.5);
                    this._applyWithAnimation(t);
                  } else this._toDefaultPosition();
                },
              },
              {
                key: "_toDefaultPosition",
                value: function () {
                  var t = a.identity();
                  this._applyWithAnimation(t);
                },
              },
              {
                ...
                value: function (t) {
                  var e = this;
                  return function () {
                    e._element.style.transform = t.toString();
                  };
                },
              },
              {
                key: "_applyWithAnimation",
                value: function (t) {
                  var e = this,
                    i =
                      arguments.length > 1 && void 0 !== arguments[1]
              ...
              },
              {
                key: "dropTransform",
                value: function () {
                  this._element.style.transform = a.identity().toString();
                },
              },
            ]),
            n && x(i.prototype, n),
        ...
        var D = (function () {
          function t() {
            !(function (t, e) {
              ...
              S(this, "_imageSrc", void 0),
              S(this, "_root", void 0),
              S(this, "_dialog", void 0),
              S(this, "_image", void 0),
              S(this, "_closeButton", void 0),
              S(this, "_hideCallback", void 0),
              S(this, "_touchModel", void 0),
              (this._imageSrc = null),
              ...
              this._root.classList.add("app-modal-root"),
              this._dialog.classList.add("app-modal"),
              this._closeButton.classList.add("app-button-close"),
              (this._closeButton.innerHTML =
                '<svg viewBox="0 0 12 12" width="16" height="16"><path d="m7.6 6 4.4 4.4-1.6 1.6L6 7.6 1.6 12 0 10.4 4.4 6 0 1.6 1.6 0 6 4.4 10.4 0 12 1.6z"/></svg>'),
              this._root.addEventListener("click", this._hideEvent.bind(this)),
              this._dialog.append(this._image),
              this._root.append(this._dialog),
              this._root.append(this._closeButton),
              (this._touchModel = new C(this._dialog));
          }
          var e, i, n;
          return (
            (e = t),
            (i = [
              {
                ...
                value: function (t) {
                  t.stopPropagation(),
                    t.composedPath().includes(this._dialog) ||
              ...
              },
              {
                key: "hide",
                value: function () {
                  this._touchModel.dropTransform(),
        ...
        document.querySelectorAll(".media").forEach(function (t) {
          var e = t.querySelector("oembed"),
            i = e.getAttribute("url"),
            n = I.find(function (t) {
              return t.test(i);
            });
          if (n) {
            ...
            o.setAttribute("src", "https://www.youtube.com/embed/".concat(s)),
              o.setAttribute("title", "YouTube video player"),
              o.setAttribute(
                "allow",
        ...
        var P = new D();
        P.setHideCallback(function () {
          P.hide();
        }),
          window.addEventListener("click", function (t) {
            t.target.matches(".article img") && P.show(t.target.src);
          }),
          document
            .querySelectorAll(
              "h2[id], .h2[id], h3[id], .h3[id], h4[id], .h4[id]"
            )
            .forEach(function (t) {
              var e = document.createElement("a");
              e.setAttribute("href", "#".concat(t.getAttribute("id"))),
                e.classList.add("blog-header-link"),
                (e.textContent = "#"),
                t.insertAdjacentElement("beforeend", e);
            }),
          document.querySelectorAll("figure.bitrixForm").forEach(function (t) {
            var e = t.dataset,
              i = e.url,
              n = e.formData;
            if (i && n) {
              var s,
                ...
                a =
                  ((s = i),
                  (o = n),
                  ((r = document.createElement("script")).async = !0),
                  (r.src = s),
                  (r.dataset.b24Form = o),
                  r);
          ...
          document.querySelectorAll("figure.image").forEach(function (t) {
